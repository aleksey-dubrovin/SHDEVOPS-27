...
3. Запуск сценария теста и проверка результатов фреймворка Molecule
...
4. Запуск сценария теста и проверка результатов фреймворка TOX
...
https://github.com/aleksey-dubrovin/vector-role/releases/tag/v.1.2.0
